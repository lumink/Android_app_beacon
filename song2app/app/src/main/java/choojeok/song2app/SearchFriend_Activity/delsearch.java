...
public class delsearch extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.delsearch_friend_page);
        ...
        Button btnDel = (Button)findViewById(R.id.DelFriendBtn);
        ...
        class InsertData extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    ...
                    String link = "http://203.252.195.99/search_d.php?ID=" + friend_search;
    ...
    public void beFriend(String friend_search, String friend_logined) {
        ...
        class InsertDatas extends AsyncTask<String, Void, String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(delsearch.this, "Please Wait", null, true, true);
            }
            ...
            protected String doInBackground(String... params){
                ...
                try {
                    ...
                    String link="http://203.252.195.99/deletefriend.php";
        ...
        Toast.makeText(this,"친구 삭제 되었습니다.",Toast.LENGTH_SHORT).show();
    }
}
